...
public class Cola extends Proceso {
    ...
    public void insertar(int llegada, int prioridad, int rafaga, int comienzo, int tfinal, int retorno, int espera, int bloqueo, String nombre) {
        Proceso nuevo;
        nuevo = new Proceso();
    ...
    public void imprimir() {
        ...
        while (aux != null) {
            System.out.println(aux.nombre + " llego en " + aux.t_llegada + " con una rafaga de " + aux.t_rafaga + " comenzo en  "
                    ...
                    + aux.t_espera + "Y una prioridad de " + aux.prioridad);
            aux = aux.siguiente;
        }
        System.out.println();
    }
